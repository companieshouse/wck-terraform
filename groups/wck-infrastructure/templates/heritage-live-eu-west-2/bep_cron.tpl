...
#LIVE##20 8 * * * /home/wck/chd3backend/paymentTXReport.sh >/dev/null 2>&1
#LIVE##*/1 0-23 * * *  /home/wck/chd3backend/monitor.sh >/dev/null 2>&1
...
#LIVE### Monitor matching process at 1130 every day
#LIVE###30 11 * * * /home/wck/chd3backend/monitorMatch.sh >/dev/null 2>&1

#LIVE### DC NEW Now call database script directlty to weed
